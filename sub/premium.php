...
<?php include dirname(__DIR__) . '/include/header.php'; ?>
	<div id="container" class="sub_container overview_container">
		...
		<section class="sec_sub_visual">
			<div class="sub_inner">
				<div class="sub_visual">
					...
					<h2 data-aos="fade-up" data-aos-duration="1000">premium</h2>
					<p data-aos="fade-up" data-aos-duration="1200">프리미엄</p>
				</div>
			</div>
		</section>
		<!-- // sub visual -->
		...
		<section class="sub_content">
			<div class="sb_inner">
				<picture class="img">
					<source srcset="/teaser2/assets/images/sub/premium_pc.png" media="(min-width: 481px)">
					<source srcset="/teaser2/assets/images/sub/premium_mb.png" media="(max-width: 480px)">
					<img src="/teaser2/assets/images/sub/premium_pc.png" alt="">
				</picture>
			</div>
			<div class="obj_wrap">
				<picture>
